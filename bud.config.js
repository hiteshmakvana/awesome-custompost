...
export default async bud => {
	 ...
	 * Setting this to a unique value ('awesome-custompost') ensures that multiple plugins can operate without
	 * interfering with each other's chunk loading mechanisms, thereby avoiding runtime conflicts.
	 */
	bud.config(
		{
			output: {
				chunkLoadingGlobal: 'awesome-custompost',
			},
		}
	)
	...
	bud.entry(
		{
			"awesome-custompost-frontend": ['/frontend/js/app.js', '/frontend/scss/app.scss'],
			"awesome-custompost-admin": ['/admin/js/app.js', '/admin/scss/app.scss']
		}
	)
